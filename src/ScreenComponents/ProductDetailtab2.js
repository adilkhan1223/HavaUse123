                            ...
                            <View>
                                <View style={styles.flatlistContainer}>
                                    ...
                                    <View style={{marginLeft:wp('2.5%')}}>
                                        <View>
                                            <Text style={{fontWeight:'bold', fontSize:11 }}>Product Name</Text>
                                        </View>
                                        ...
                                        <View style={{flexDirection:'row',
                                            ...
                                            <View style={styles.flatlistbadge}>
                                                ...
                                                />
                                                <Text style={{color:'#fff', fontSize:11}}>5.0 </Text>
                                            </View>
                                            <View style={{marginLeft:wp('1.5%')}}>
                                                <Text style={{fontSize:11}}>(409)</Text>
                                            </View>
                                        </View>

                                        <View>
                                            <Text style={{fontSize:12, fontWeight:'900'}}>$60.00 - $70.00</Text>
                                        </View>
                                    </View>    
                                </View>
                            </View>
