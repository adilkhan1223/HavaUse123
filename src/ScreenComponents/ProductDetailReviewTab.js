...
const Reviews = [
    {
      ...
      message:'Lorem ipsum, or lipsum as it is sometimes known, is dummy text usein laying out print, graphic or web designs.',
      illustration: "https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
    },
    {
        name: "Dennis Watkins",
        joindate: "Joined 2020",
                            ...
                            <View style={{flexDirection:'row', justifyContent:'space-between', marginTop:hp('2%')}}>
                                    <View style={{flexDirection:'row'}}>
                                        ...
                                        <View>
                                            ...
                                            <View><Text>{item.joindate}</Text></View>
                                        </View>
                                    </View>
                                <View style={{flexDirection:'row',}}>
                                    ...
                                    <Icon name='star' style={{fontSize:17, color:'#3FAD72'}} />
                                    <Icon name='star' style={{fontSize:17, color:'#3FAD72'}} />
                                    <Icon name='star' style={{fontSize:17, color:'lightgrey'}} />
