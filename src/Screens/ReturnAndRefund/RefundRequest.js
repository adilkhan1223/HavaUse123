            ...
            <View style={{marginTop:hp('15%')}}>
                <Card style={{padding: 10, borderRadius:15}}>
                   ...
                   <View style={{alignSelf:'center'}}>
                        <Text style={{fontWeight:'bold', fontSize:18}}>Ask For Refund</Text>
                    </View>
                    ...
                    <View style={{flexDirection:'row', justifyContent:'space-between', marginVertical:hp('1%')}}>
                        <TouchableOpacity style={styles.button8}>
                            <Text style={{color:'#FFF', fontSize:20}}>{addImage.length} / 8</Text>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity style={styles.buttonadd} onPress={TestCamera}>
                            ...
                            <Text style={{color:'#FFF', fontSize:16}}>Add photos</Text>
                        </TouchableOpacity>
                    </View>


                    <Card style={{padding:15, borderRadius:10}}>
                        <Text style={{color:'grey'}}>lipsum as it is sometimes known, is dummy text used in 
