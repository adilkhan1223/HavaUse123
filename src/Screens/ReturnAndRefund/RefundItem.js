            ...
            <View style={{marginTop:hp('15%')}}>
                <Card style={{padding: 10, borderRadius:15, height:hp('100%')}}>
                   ...
                   <View style={{alignSelf:'center', marginBottom:hp('2%')}}>
                        <Text style={{fontWeight:'bold', fontSize:18}}>Refund Item</Text>
                    </View>
                    ...
                    <View style={{ flexDirection:'row',height:hp('7%'), borderRadius:10, borderColor:'lightgrey',borderWidth:1}}>
                        ...
                        <View style={{alignSelf:'center',}}>
                            <Text style={{marginLeft:wp('20%'), fontSize:16, color:'grey'}}>
                                You Got a refund
                            </Text>
                        </View>
                    </View>
                    ...
                    <View style={{alignItems:'center', marginVertical:hp('1%')}}>
                        <Text style={{color:'grey', paddingHorizontal:wp('5%'), fontSize:13}}>
                    ...
                    <Card style={{padding:15, borderRadius:10}}>
                        ...
                        <View style={{flexDirection:'row', justifyContent:'space-between', marginTop:hp('1%')}}>
                            <Text style={{fontSize:15, color:'grey'}}>Tax</Text>
                            <Text style={{fontSize:15, color:'grey'}}>$ 10.05</Text>
                        </View>
                        ...
                        <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                            <Text style={{fontSize:15, color:'grey', fontWeight:'bold'}}>Total Refund</Text>
                            <Text style={{fontSize:15, color:'grey', fontWeight:'bold'}}>$ 122.19</Text>
                        </View>

                        <View style={{flexDirection:'row', justifyContent:'space-between' , marginTop:hp('1%')}}>
                            <Text style={{fontSize:15, color:'grey'}}>Refunded To</Text>
                            <Text style={{fontSize:15, color:'grey'}}>Orignal Payment Method</Text>
                        </View>
                    </Card>
                        {/* 2nd card */}
                    <Card style={{padding:15, borderRadius:10}}>
                        <View style={{flexDirection:'row'}}>
                            ...
                            <View style={{paddingLeft:10}}>
                                ...
                                <View style={{flexDirection:'row', marginVertical:hp('0.9%')}}>
                                    ...
                                    <Text style={{fontSize:13}}>114 Village Post Road </Text>
                                 </View>
                    ...
                    <View style={{flexDirection:'row',
                           ...
                           marginTop:hp('2%')}}>
              <View>
                <Text style={{fontSize:15, color:'#5E5E5E'}}>Related Sponsored Items</Text>
              </View>
