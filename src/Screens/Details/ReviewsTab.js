        ...
        <View style={{marginTop:hp('2%')}}>
                <View style={{borderBottomWidth:1, borderBottomColor:'lightgrey'}}>        
                    <View style={{marginHorizontal:('2.5%'), marginBottom:hp('2%')}}>
                        <View><Text style={{fontSize:15, fontWeight:'bold'}}>Rating &</Text></View>
                        <View style={{marginTop:hp('1%'), flexDirection:'row'}}>
                            <View>
                                <Text style={{fontWeight:'bold', fontSize:30}}>4.90</Text>
                            </View>
                            <View style={{paddingLeft:10}}>
                                ...
                                <Text style={{color:"grey"}}>126 Product Rating</Text>
                ...
                <View style={{ borderBottomWidth:1, borderBottomColor:'lightgrey'}}>
                    ...
                    <View style={{width:wp('35%')}}>
                            <Text style={{color:'grey', }}>would recommend</Text>
                        </View>
                        ...
                        <Text style={{width:wp('10%')}}>100%</Text>
                    </View>
                    {/* 2nd progress bar */}
                    ...
                    <View style={{flexDirection:'row', justifyContent:'space-between',marginHorizontal:wp('2.5%'), marginTop:hp('2%')}}>
                        ...
                        <View style={{width:wp('35%')}}>
                            <Text style={{color:'grey', }}>good value</Text>
                        </View>
                        <View style={{alignSelf:'center'}}>
                        <ProgressBarAnimated
                            width={wp('40%')}
                    ...
                    <View style={{width:wp('35%')}}>
                            <Text style={{color:'grey', }}>good quality</Text>
                        </View>
                        <View style={{alignSelf:'center'}}>
                        <ProgressBarAnimated
                            width={wp('40%')}
                        ...
                        <Text style={{width:wp('10%')}}>80%</Text>
                    </View>
                ...
                <View style={{ borderBottomWidth:1, borderBottomColor:'lightgrey'}}>
                    <View style={{marginHorizontal:wp('2.5%')}}>    
                        <View style={{marginTop:hp('2%')}}>
                            <Text style={{fontWeight:'bold', fontSize:15}}>Detailed Seller Ratings</Text>
                        </View>

                        <View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'center',marginTop:hp('2%')}}>
                            <View style={{width:wp('35%')}}>
                                <Text style={{color:'grey'}}>item as described</Text>
                            </View>
                            ...
                            <View style={{width:wp('12%')}}>
                                <Text style={{color:'grey'}}>(306)</Text>
                            </View>
                        </View>
                    </View>
                    {/* 2nd row */}
                    <View style={{marginHorizontal:wp('2.5%')}}>    
                        ...
                        <View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'center',marginTop:hp('2%')}}>
                            <View style={{width:wp('35%')}}>
                                <Text style={{color:'grey'}}>communication</Text>
                            </View>
                            <View style={{width:wp('40%'), flexDirection:'row'}}>
                                <Icon style={{fontSize:20}} name='star' />
                                <Icon style={{fontSize:20}} name='star' />
                    ...
                    <View style={{marginHorizontal:wp('2.5%')}}>    
                        ...
                        <View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'center',marginTop:hp('2%')}}>
                            <View style={{width:wp('35%')}}>
                                <Text style={{color:'grey'}}>shipping time</Text>
                            </View>
                            <View style={{width:wp('40%'), flexDirection:'row'}}>
                                <Icon style={{fontSize:20}} name='star' />
                                <Icon style={{fontSize:20}} name='star' />
                            ...
                            <View style={{width:wp('12%')}}>
                                <Text style={{color:'grey'}}>(318)</Text>
                            </View>
                        </View>
                    </View>
                    {/* 4th Row */}
                    <View style={{marginHorizontal:wp('2.5%'), marginBottom:hp('2%')}}>    
                        ...
                        <View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'center',marginTop:hp('2%')}}>
                            <View style={{width:wp('35%')}}>
                                <Text style={{color:'grey'}}>shipping charges</Text>
                            </View>
                            <View style={{width:wp('40%'), flexDirection:'row'}}>
                                <Icon style={{fontSize:20}} name='star' />
                                <Icon style={{fontSize:20}} name='star' />
                            ...
                            <View style={{width:wp('12%')}}>
                                <Text style={{color:'grey'}}>(326)</Text>
                            </View>
                        </View>
                    </View>
                ...
                <View>
                        <View style={{flexDirection:'row',
                                ...
                                marginVertical:hp('2%')}}>
                            <View><Text style={{fontWeight:'bold' , fontSize:15}}>Recent Feedbact Ratings</Text></View>
                        ...
                        <View>
                            <View style={{flexDirection:'row', marginHorizontal:wp("2.5%"), marginTop:hp('2%')}}>
                                <View style={{width:wp('40%'), flexDirection:'row'}}>
                                    ...
                                    <Text style={{paddingLeft:7}}>positive</Text>
                                </View>
                                <View style={{flexDirection:'row', width:wp('40%'), justifyContent:'space-between'}}>
                                    <Text style={{color:'#3FAD72'}}>51</Text>
                                    <Text style={{color:'#3FAD72'}}>303</Text>
                                    <Text style={{color:'#3FAD72'}}>121</Text>
                                </View>
                            </View>
                        </View>
                        {/* 3rd Row */}
                        ...
                        <View>
                            <View style={{flexDirection:'row', marginHorizontal:wp("2.5%"), marginTop:hp('2%')}}>
                                ...
                                <View style={{flexDirection:'row', width:wp('40%'), justifyContent:'space-between'}}>
                                    <Text style={{color:'#6C6C6C'}}>12</Text>
                                    <Text style={{color:'#6C6C6C'}}>21</Text>
                                    <Text style={{color:'#6C6C6C'}}>121</Text>
                                </View>
                            </View>
                        </View>
                        {/* 4th Row */}
                        <View>
                            <View style={{flexDirection:'row', marginHorizontal:wp("2.5%"), marginTop:hp('2%')}}>
                                ...
                                <View style={{flexDirection:'row', width:wp('40%'), justifyContent:'space-between'}}>
                                    <Text style={{color:'#EA4673'}}>1</Text>
                                    <Text style={{color:'#EA4673'}}>3</Text>
                                    <Text style={{color:'#EA4673'}}>12</Text>
                                </View>
                            </View>
                        </View>
                ...
                <View>
                    <View style={{flexDirection:'row',
                            ...
                            marginHorizontal:wp("2.5%"),
                            marginVertical:hp('2%')}}>
                        <View><Text style={{fontWeight:'bold' , fontSize:15}}>Related Items</Text></View>
                    </View>
