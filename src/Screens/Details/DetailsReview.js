...
const DetailsReview=()=> {
    ...
    return (
        <ScrollView>
            ...
            <View style={{flexDirection:'row', alignItems:'center',marginTop:hp('2%'), marginHorizontal:wp('2.5%'), justifyContent:'space-between'}}>
                <View>
            ...
            <View style={{backgroundColor:'#fff', borderTopWidth:1, borderTopColor:'lightgrey', marginTop:hp('2%')}}> 
                  <Tabs locked={true} tabBarUnderlineStyle = {{backgroundColor:"#3FAD72",height:2 }} tabContainerStyle = {{backgroundColor:'transparent',borderWidth:1, borderBottomWidth:1, elevation:0 }}>
                    <Tab heading="Havazuse product" textStyle={{color:"lightgrey", fontWeight:'900'}} tabStyle = {{backgroundColor:"transparent",}} activeTabStyle = {{ backgroundColor:"transparent",}} activeTextStyle = {{color:"#3FAD72ed"}}>
                    ...
                    <Tab heading="Reviews" textStyle={{color:"lightgrey",fontWeight:'900'}} tabStyle = {{backgroundColor:"transparent", }} activeTabStyle = {{ backgroundColor:"transparent",}} activeTextStyle = {{color:"#3FAD72ed"}}>
                         <View><ReviewsTab  /></View>
                    </Tab>

                    <Tab heading="Store details" textStyle={{color:"lightgrey",fontWeight:'900',}} tabStyle = {{backgroundColor:"transparent", }} activeTabStyle = {{ backgroundColor:"transparent",}} activeTextStyle = {{color:"#3FAD72ed"}}>
                         <View><StoreDetailtab   /></View>
                    </Tab>
