        ...
        <ScrollView>
           ...
           <View style={{flexDirection:'row', marginTop:hp('2%')}}>
                ...
                <View style={styles.weightdropdown}>
                    <TouchableOpacity style={{flexDirection:'row', width:wp('25%'), justifyContent:'space-around'}}>
                        <Text>Filter</Text>
                        <Icon name='filter' />
                    </TouchableOpacity>
                </View>
            ...
            <View style={{flexDirection:'row',
                           ...
                           marginTop:hp('2%')}}>
              <Text style={{fontWeight:'bold'}}>Good Price</Text>
                  ...
                  <View>
                   <View style={{marginRight:wp('2%'),marginVertical:hp('1%')}}> 
                      <View style={{height:hp('17%'), width:wp('31%'),}}>
                       <Image source={{uri: item.image}}  style={styles.flatlistimage1} />
                       <View style={styles.discountbadge}>
                           <Icon style={{fontSize:10, color:'#FFF'}} name="menu"  />
            ...
            <View style={{flexDirection:'row',
                           ...
                           marginHorizontal:wp("1%"),
                           marginTop:hp('2%')}}>
              <Text style={{fontWeight:'bold'}}>Limited Offer</Text>
              <Text style={{fontWeight:'bold'}}>End in <Text style={{color:'#3FAD72'}}>07 :38 : 56</Text></Text>
              <Text style={{color:'#3FAD72'}}>View All</Text>
            </View>
            ...
            <View style={{flexDirection:'row',
                           ...
                           marginHorizontal:wp("1%"),
                           marginTop:hp('2%')}}>
              <Text style={{fontWeight:'bold'}}>Best Selling</Text>
              <Text style={{color:'#3FAD72'}}>View All</Text>
            </View>
            ...
            <View style={{flexDirection:'row',
                           ...
                           marginHorizontal:wp("1%"),
                           marginTop:hp('2%')}}>
              <Text style={{fontWeight:'bold'}}>Recommended Projects Guide</Text>
              <Text style={{color:'#3FAD72'}}>View All</Text>
            </View>
            ...
            <View style={styles.imageSliderbottom}>
                    <Swiper style={styles.wrapper} showsButtons={true} showsPagination={false}>
                      {Swipper.map && Swipper.map( (item, i) => {
                            return(
