  ...
  const[tab2,setTab2]= useState(false)
      ...
      return(
       ...
       <View  style={styles.logo}>
        ...
        <View style = {{borderWidth:2,borderColor:"#3FAD72",flexDirection:"row",justifyContent:"space-between",width:"90%",alignSelf:"center",borderRadius:24}}>
        <Tab Text = "User Resgistration" backgroundColor ={ tab1 ? "#3FAD72" : "#FFFFFF"} onPress = {()=>{
          setTab1(true) ;
          setTab2(false)
        }
        } />

        <Tab Text = "Vendor Registration" backgroundColor ={ tab2 ? "#3FAD72" : "#FFFFFF"} onPress = {()=>{
          setTab2(true);
          setTab1(false)
        }} />
        </View>
