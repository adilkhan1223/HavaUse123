           ...
           <View style={{alignItems:'center',}}>
            ...
            {/* Tabs Navigations */}
                ...
                <View style={{backgroundColor:'transparent'}}> 
                  <Tabs  tabBarUnderlineStyle = {{backgroundColor:"#3FAD72", width:50, marginHorizontal:wp('6%') }} tabContainerStyle = {{backgroundColor:'transparent',borderWidth:1,borderBottomWidth:1, elevation:0 }}>
