...
const MenuTab=()=> {
    ...
    return (
        <View>
            <View style={{flexDirection:'row', justifyContent:'space-around', marginHorizontal:wp('1%'), marginTop:hp('1%')}}>
                <View  style={styles.searchIcon}>
                    <TouchableOpacity><Icon style={{color:'grey'}} name='search' />                    
                    </TouchableOpacity>
                </View>
            ...
            <View>
                    ...
                    <View style={{marginHorizontal:wp('2%')}}>
                        <Text style={{fontWeight:'bold', fontSize:17}}>Title/Heading here</Text>
                    </View>
                    ...
                    renderItem={({item, })=>{
                        return(
                            <View>
                                <View style={styles.flatlistContainer}>
                                        <View style={styles.imageConatiner}>
                                            <Image style={styles.flatlistImage1} resizeMode='stretch' source={{uri: item.illustration}} />
                                            <View >
                                                <View style={{marginLeft:wp('33%'), marginTop:hp('1%')}}>
                                                    <Icon name='heart'  />
                                                </View>
                                             </View>   
                                        </View>
