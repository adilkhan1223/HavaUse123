...
import { View, Text, StyleSheet, Image, Dimensions, FlatList, ScrollView, TextInput, TouchableOpacity } from 'react-native';
...
const data= [
  {
    title:'Brownies',
    logo: 'gm',
    imagee: require('../../../issets/brownie.png')
  },
  {
    title:'Muffins',
    logo: 'gm',
    imagee: require('../../../issets/cupcake.png')

  },
  {
    title:'Cookies',
    logo: 'gm',
    imagee: require('../../../issets/cookie.png')

  },
  {
    title:'Vape',
    logo: 'gm',
    imagee: require('../../../issets/vape.png')

  },
  {
    title:'Weed',
    logo: 'gm',
    imagee: require('../../../issets/weed.png')

  },
  {
    title:'Cake',
    logo: 'gm',
    imagee: require('../../../issets/candy.png')
    ...
    <ScrollView>
      <Header style={{backgroundColor:'transparent', elevation:0}}>
          ...
          <View style={styles.searchbar}>
            ...
            {/* Store  Front button */}
           <View style={{flexDirection:'row', marginTop:hp('2%'), marginHorizontal:wp('3%'), justifyContent:'space-between' }}>
                <TouchableOpacity style={styles.storefrontbutton}>
                    <Image source={require('../../../issets/button2.png')} />
                    <Text style={{color:'#fff'}}>Storefronts</Text>
                </TouchableOpacity>
                <View style={styles.dispenseryinput}>
                    <Icon style={{fontSize:18, color:'grey', paddingLeft:8, paddingRight:5}} name='location' />
                    <TextInput style={{width:wp('50%')}} placeholder='Dispensary near me' />
                </View>
           ...
           <View style={{alignItems:'center',}}>
            ...
            <View style={{flexDirection:'row',
              ...
              <View><Text style={{color:'#3FAD72'}}>View All</Text></View>
            </View>
          ...
          {/* End of WeedClothing button */}
            ...
            {/* Tabs Navigations */}
                ...
                <View style={{backgroundColor:'transparent'}}> 
                  <Tabs locked={true} tabBarUnderlineStyle = {{backgroundColor:"#3FAD72", width:50, marginHorizontal:wp('6%') }} tabContainerStyle = {{backgroundColor:'transparent',borderWidth:1,borderBottomWidth:1, elevation:0 }}>
                    ...
                    <Tab heading="Muffins" textStyle={{color:"#000",fontWeight:'bold'}} tabStyle = {{backgroundColor:"transparent", }} activeTabStyle = {{ backgroundColor:"transparent",}} activeTextStyle = {{color:"#3FAD72ed"}}>
                         <View><Muffins  /></View>
                    </Tab>
                    <Tab heading="Cookies" textStyle={{color:"#000", fontWeight:'bold'}} tabStyle = {{backgroundColor:"transparent", }} activeTabStyle = {{ backgroundColor:"transparent",}} activeTextStyle = {{color:"#3FAD72ed"}}>
                          <View><Cookies  /></View>
                    </Tab>
                    <Tab heading="Weed" textStyle={{color:"#000", fontWeight:'bold'}} tabStyle = {{backgroundColor:"transparent", }} activeTabStyle = {{ backgroundColor:"transparent",}} activeTextStyle = {{color:"#3FAD72ed"}}>
                            <View><Weed  /></View>
                    </Tab>
                  </Tabs>
                  </View>
                  ...
                  <View style={{flexDirection:'row',
                           ...
                           marginHorizontal:wp("3%"),
                           marginTop:hp('2%')}}>
                      <View><Text style={{fontWeight:'bold'}}>Recommended Project Guide</Text></View>
                      <View><Text style={{color:'#3FAD72'}}>View All</Text></View>
                  </View>
