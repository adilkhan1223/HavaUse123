          ...
          <View style={styles.searchbar}>
           ...
           {/* End of header and search input */}
            ...
            <View style={{marginVertical:wp('2%')}}>
                <Text style={{fontWeight:'bold'}}>Dispensaries</Text>
            </View>
                {/* Flatlis Cards */}
                    <FlatList
                    data={data}
                    renderItem={({item, index}) =>{
                        return(
                            <View>
                    <Card style={{borderRadius:10, padding:10, paddingTop:15, paddingBottom:15 }}>
                        <View style={{flexDirection:'row', }}>
                            <View style={styles.portion1}>
                                {/* <ImageBackground  source={require('../../../issets/background.png')}> */}
                                    <View>
                                        <Image style={{position:'absolute', width:wp('42%')}} 
                                        source={require('../../../issets/background.png')}
                                         />
                                    </View>
                                    <View style={{padding:10}}>
                                    <View style={{alignItems:'flex-end',}}>
                                        <Image style={{height:hp('5%'), width:wp('10%')}} source={require('../../../issets/storebutton.png')} />
                                    </View>
                                    <View style={{flexDirection:'row',}}>
                                        <View style={styles.imagecontainer}></View>
                                        <View style={{justifyContent:'flex-end'}}>
                                            <Text style={{fontWeight:'bold', paddingLeft:5 , fontSize:14, width:wp('20%')}}>{item.StoreName}</Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={{flexDirection:'row', justifyContent:'space-between' }}>
                                        ...
                                        <Text style={{color:'#FFF'}}>{item.Rating}</Text>
                                            ...
                                            <View><Text>{item.RatingNumber}</Text></View>
                                            <View><Text>{item.RatingText}</Text></View>
                                    </View>

                                {/* </ImageBackground> */}
                                </View>
                            </View>
                            <View style={{width:wp('60%'), justifyContent:'space-evenly', paddingLeft:10}}>
                                <View>
                                    <TouchableOpacity style={styles.buttoncall}>
                                        <Icon style={{color:'#fff', fontSize:22}} name='call'  />
                                        <Text style={{color:'#fff', paddingLeft:10}}>Call</Text>
                                    </TouchableOpacity>
                                </View>
                                <View>
                                    <TouchableOpacity style={styles.buttonhours}>
                                        <Icon style={{fontSize:22}} name='time' />
                                        <Text style={{color:'grey', paddingLeft:10}}>Hours</Text>
                                    </TouchableOpacity>
                                </View>
                                <View>
                                    <TouchableOpacity style={styles.buttondirection}>
                                        <Icon style={{fontSize:22}} name='directions' type='MaterialCommunityIcons'  />
                                        <Text style={{color:'grey', paddingLeft:10}}>Direction</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                        </View>
